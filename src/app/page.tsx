...
import FramerCarouselComponent from '@/components/composites/FramerCarousel';

const LINKEDIN_URL = 'https://linkedin.com/in/doduronbi';
const GITHUB_URL = 'https://github.com/oracleot';
const RESUME_URL =
  'https://docs.google.com/document/d/11x_aKqKuolZj3bCXA-_XicOJwGEV8d3d2NvB3nzw8XQ';
