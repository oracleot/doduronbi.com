  ...
  return (
    ...
    >
      <div className="flex items-center flex-col gap-3">
        ...
        <h2 className="text-lg md:text-xl">Software Engineer | Exploring AI & LLMs</h2>
        <h3 className="px-4 md:px-0 text-center text-[var(--mid-gray)] max-w-[500px]">
        <strong>Building scalable, high-performance solutions</strong> with a broad tech stack including modern web frameworks, languages, and cloud platforms to help businesses innovate and thrive.
        </h3>
      </div>
    </div>
  );
